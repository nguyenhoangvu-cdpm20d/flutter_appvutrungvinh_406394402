...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/music/pop/Easy/db_connect_flutter.dart';
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/sport/basketball/Easy/db_connect_flutter.dart';
...
class Pop_Easy_QuestionScreen extends StatefulWidget {
  const Pop_Easy_QuestionScreen({super.key});

  @override
  State<Pop_Easy_QuestionScreen> createState() =>
      Pop_Easy_QuestionScreenState();
}

class Pop_Easy_QuestionScreenState extends State<Pop_Easy_QuestionScreen> {
  var db = DBConnect_Pop_Easy();
  // List<Question> _question = [
  //   Question(id: '1', title: ' Pop tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'Pop: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích Pop',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong Pop': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong Pop',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //       id: '6',
  //       title:
  //           ' Đáp án nào sau đây không được xác định trước bởi Pop (Magic constants)',
  //       option: {
  //         ' __LINE__': false,
  //         '__FILE__': false,
  //         '__DATE__': true,
  ...
  //     'Lệnh include dùng để nhúng file Pop vào trang': true,
  //     'Lệnh include dùng để chạy 1 file Pop rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, Pop, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển Pop', option: {
  //     'Rasmus Lerdorf': true,
