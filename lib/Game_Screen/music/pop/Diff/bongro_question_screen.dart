...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/music/pop/Diff/db_connect_flutter.dart';
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/sport/basketball/Diff/db_connect_flutter.dart';
...
class Pop_Diff_QuestionScreen extends StatefulWidget {
  const Pop_Diff_QuestionScreen({super.key});

  @override
  State<Pop_Diff_QuestionScreen> createState() =>
      Pop_Diff_QuestionScreenState();
}

class Pop_Diff_QuestionScreenState extends State<Pop_Diff_QuestionScreen> {
  var db = DBConnect_Pop_Diff();
  // List<Question> _question = [
  //   Question(id: '1', title: ' Flutter tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'Flutter: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích Flutter',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong Flutter': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong Flutter',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //       id: '6',
  //       title:
  //           ' Đáp án nào sau đây không được xác định trước bởi Flutter (Magic constants)',
  //       option: {
  //         ' __LINE__': false,
  //         '__FILE__': false,
  //         '__DATE__': true,
  ...
  //     'Lệnh include dùng để nhúng file Flutter vào trang': true,
  //     'Lệnh include dùng để chạy 1 file Flutter rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, Flutter, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển Flutter', option: {
  //     'Rasmus Lerdorf': true,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<Pop>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<Pop>;
            return Scaffold(
