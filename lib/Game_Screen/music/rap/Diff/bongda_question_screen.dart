...
class Rap_Diff_QuestionScreen extends StatefulWidget {
  const Rap_Diff_QuestionScreen({super.key});

  @override
  State<Rap_Diff_QuestionScreen> createState() =>
      Rap_Diff_QuestionScreenState();
}

class Rap_Diff_QuestionScreenState extends State<Rap_Diff_QuestionScreen> {
  var db = DBConnect_Rap_Diff();
