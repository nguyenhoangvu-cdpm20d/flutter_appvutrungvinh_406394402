...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/music/rap/Easy/db_connect_sql.dart';
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/sport/football/Easy/db_connect_sql.dart';
...
class Rap_Easy_QuestionScreen extends StatefulWidget {
  const Rap_Easy_QuestionScreen({super.key});

  @override
  State<Rap_Easy_QuestionScreen> createState() =>
      Rap_Easy_QuestionScreenState();
}

class Rap_Easy_QuestionScreenState extends State<Rap_Easy_QuestionScreen> {
  var db = DBConnect_Rap_Easy();
  // List<Question> _question = [
  //   Question(id: '1', title: ' Rap tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'Rap: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích Rap',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong Rap': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong Rap',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //       id: '6',
  //       title:
  //           ' Đáp án nào sau đây không được xác định trước bởi Rap (Magic constants)',
  //       option: {
  //         ' __LINE__': false,
  //         '__FILE__': false,
  //         '__DATE__': true,
  ...
  //     'Lệnh include dùng để nhúng file Rap vào trang': true,
  //     'Lệnh include dùng để chạy 1 file Rap rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, Rap, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển Rap', option: {
  //     'Rasmus Lerdorf': true,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<Rap>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<Rap>;
            return Scaffold(
