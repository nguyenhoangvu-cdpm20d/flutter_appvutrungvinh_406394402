...
class Flutter_Easy_QuestionScreen extends StatefulWidget {
  const Flutter_Easy_QuestionScreen({super.key});

  @override
  State<Flutter_Easy_QuestionScreen> createState() =>
      Flutter_Easy_QuestionScreenState();
}

class Flutter_Easy_QuestionScreenState
    extends State<Flutter_Easy_QuestionScreen> {
  var db = DBConnect_Flutter_Easy();
  ...
  // ];
  Future? _questions;
  Future<List<Flutter>> getData() async {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<Flutter>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<Flutter>;
            return Scaffold(
