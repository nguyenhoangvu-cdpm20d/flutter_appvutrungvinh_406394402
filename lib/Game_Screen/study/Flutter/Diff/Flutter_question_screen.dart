...
class Flutter_Diff_QuestionScreen extends StatefulWidget {
  ...
  @override
  State<Flutter_Diff_QuestionScreen> createState() =>
      Flutter_Diff_QuestionScreenState();
}

class Flutter_Diff_QuestionScreenState
    extends State<Flutter_Diff_QuestionScreen> {
  var db = DBConnect_Flutter_Diff();
