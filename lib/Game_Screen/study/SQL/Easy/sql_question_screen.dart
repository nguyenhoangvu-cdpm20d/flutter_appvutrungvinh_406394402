...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/study/SQL/Easy/db_connect_sql.dart';
...
class SQL_Easy_QuestionScreen extends StatefulWidget {
  const SQL_Easy_QuestionScreen({super.key});

  @override
  State<SQL_Easy_QuestionScreen> createState() =>
      SQL_Easy_QuestionScreenState();
}

class SQL_Easy_QuestionScreenState extends State<SQL_Easy_QuestionScreen> {
  var db = DBConnect_SQL_Easy();
