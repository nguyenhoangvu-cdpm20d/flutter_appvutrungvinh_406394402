...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/study/SQL/Diff/db_connect_sql.dart';
...
class SQL_Diff_QuestionScreen extends StatefulWidget {
  const SQL_Diff_QuestionScreen({super.key});

  @override
  State<SQL_Diff_QuestionScreen> createState() =>
      SQL_Diff_QuestionScreenState();
}

class SQL_Diff_QuestionScreenState extends State<SQL_Diff_QuestionScreen> {
  var db = DBConnect_SQL_Diff();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<SQL>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<SQL>;
            return Scaffold(
