...
class PHP_Easy_QuestionScreen extends StatefulWidget {
  const PHP_Easy_QuestionScreen({super.key});

  @override
  State<PHP_Easy_QuestionScreen> createState() =>
      PHP_Easy_QuestionScreenState();
}

class PHP_Easy_QuestionScreenState extends State<PHP_Easy_QuestionScreen> {
  var db = DBConnect_PHP_Easy();
