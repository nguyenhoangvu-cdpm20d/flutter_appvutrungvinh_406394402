...
class PHP_Diff_QuestionScreen extends StatefulWidget {
  const PHP_Diff_QuestionScreen({super.key});

  @override
  State<PHP_Diff_QuestionScreen> createState() =>
      PHP_Diff_QuestionScreenState();
}

class PHP_Diff_QuestionScreenState extends State<PHP_Diff_QuestionScreen> {
  var db = DBConnect_PHP_Diff();
  // List<Question> _question = [
  //   Question(id: '1', title: ' PHP tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'PHP: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích PHP',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong PHP': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong PHP',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //     'Lệnh include dùng để nhúng file php vào trang': true,
  //     'Lệnh include dùng để chạy 1 file php rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, php, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển PHP', option: {
  //     'Rasmus Lerdorf': true,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<PHP>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<PHP>;
            return Scaffold(
