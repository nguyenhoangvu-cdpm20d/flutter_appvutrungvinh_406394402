...
class BongDa_Easy_QuestionScreen extends StatefulWidget {
  const BongDa_Easy_QuestionScreen({super.key});

  @override
  State<BongDa_Easy_QuestionScreen> createState() =>
      BongDa_Easy_QuestionScreenState();
}

class BongDa_Easy_QuestionScreenState
    extends State<BongDa_Easy_QuestionScreen> {
  var db = DBConnect_BongDa_Easy();
