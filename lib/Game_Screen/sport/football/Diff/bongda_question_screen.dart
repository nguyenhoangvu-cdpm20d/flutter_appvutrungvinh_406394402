...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/music/rap/Diff/db_connect_sql.dart';
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/sport/football/Diff/db_connect_sql.dart';
...
class BongDa_Diff_QuestionScreen extends StatefulWidget {
  const BongDa_Diff_QuestionScreen({super.key});

  @override
  State<BongDa_Diff_QuestionScreen> createState() =>
      BongDa_Diff_QuestionScreenState();
}

class BongDa_Diff_QuestionScreenState
    extends State<BongDa_Diff_QuestionScreen> {
  var db = DBConnect_BongDa_Diff();
  // List<Question> _question = [
  //   Question(id: '1', title: ' BongDa tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'BongDa: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích BongDa',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong BongDa': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong BongDa',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //       id: '6',
  //       title:
  //           ' Đáp án nào sau đây không được xác định trước bởi BongDa (Magic constants)',
  //       option: {
  //         ' __LINE__': false,
  //         '__FILE__': false,
  //         '__DATE__': true,
  ...
  //     'Lệnh include dùng để nhúng file BongDa vào trang': true,
  //     'Lệnh include dùng để chạy 1 file BongDa rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, BongDa, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển BongDa', option: {
  //     'Rasmus Lerdorf': true,
  ...
  // ];
  Future? _questions;
  Future<List<BongDa>> getData() async {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<BongDa>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<BongDa>;
            return Scaffold(
