...
import 'package:flutter_appvutrungvinh_406394402/Game_Screen/sport/volleyball/Diff/db_connect_sql.dart';
...
class BongChuyen_Diff_QuestionScreen extends StatefulWidget {
  const BongChuyen_Diff_QuestionScreen({super.key});

  @override
  State<BongChuyen_Diff_QuestionScreen> createState() =>
      BongChuyen_Diff_QuestionScreenState();
}

class BongChuyen_Diff_QuestionScreenState
    extends State<BongChuyen_Diff_QuestionScreen> {
  var db = DBConnect_BongChuyen_Diff();
  // List<Question> _question = [
  //   Question(id: '1', title: ' BongChuyen tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'BongChuyen: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích BongChuyen',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong BongChuyen': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong BongChuyen',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //       id: '6',
  //       title:
  //           ' Đáp án nào sau đây không được xác định trước bởi BongChuyen (Magic constants)',
  //       option: {
  //         ' __LINE__': false,
  //         '__FILE__': false,
  //         '__DATE__': true,
  ...
  //     'Lệnh include dùng để nhúng file BongChuyen vào trang': true,
  //     'Lệnh include dùng để chạy 1 file BongChuyen rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, BongChuyen, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển BongChuyen', option: {
  //     'Rasmus Lerdorf': true,
  ...
  // ];
  Future? _questions;
  Future<List<BongChuyen>> getData() async {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<BongChuyen>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<BongChuyen>;
            return Scaffold(
