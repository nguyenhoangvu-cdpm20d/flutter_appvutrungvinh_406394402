...
class BongChuyen_Easy_QuestionScreen extends StatefulWidget {
  const BongChuyen_Easy_QuestionScreen({super.key});

  @override
  State<BongChuyen_Easy_QuestionScreen> createState() =>
      BongChuyen_Easy_QuestionScreenState();
}

class BongChuyen_Easy_QuestionScreenState
    extends State<BongChuyen_Easy_QuestionScreen> {
  var db = DBConnect_BongChuyen_Easy();
