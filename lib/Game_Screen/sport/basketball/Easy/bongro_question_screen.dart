...
class BongRo_Easy_QuestionScreen extends StatefulWidget {
  const BongRo_Easy_QuestionScreen({super.key});

  @override
  State<BongRo_Easy_QuestionScreen> createState() =>
      BongRo_Easy_QuestionScreenState();
}

class BongRo_Easy_QuestionScreenState
    extends State<BongRo_Easy_QuestionScreen> {
  var db = DBConnect_BongRo_Easy();
  // List<Question> _question = [
  //   Question(id: '1', title: ' BongRo tượng trưng cho cái gì:', option: {
  //     'Preprocessed Hypertext Page': false,
  //     ' ': false,
  //     'BongRo: Hypertext Preprocessor': true,
  //     'Hypertext Markup Language': false
  //   }),
  //   Question(
  //       id: '2',
  //       title: ' Đoạn mã nào sau đây được sử dụng để chú thích BongRo',
  //       option: {
  ...
  //         'null': true,
  //         'undef': false,
  //         'Không có khái niệm như vậy trong BongRo': false,
  //       }),
  //   Question(
  //       id: '4',
  //       title: ' Ký hiệu nào được dùng khi sử dụng biến trong BongRo',
  //       option: {
  //         ' /* commented code here */': false,
  //         '// you are handsome': false,
  //         '# you are gay': false,
  ...
  //       id: '6',
  //       title:
  //           ' Đáp án nào sau đây không được xác định trước bởi BongRo (Magic constants)',
  //       option: {
  //         ' __LINE__': false,
  //         '__FILE__': false,
  //         '__DATE__': true,
  ...
  //     'Lệnh include dùng để nhúng file BongRo vào trang': true,
  //     'Lệnh include dùng để chạy 1 file BongRo rồi nhúng kết quả của file đó vào trang':
  //         false,
  //     'Lệnh include chỉ có thể được dùng 1 lần trong trang': false,
  //     'Lệnh include có thể nhúng file html, BongRo, js, css': false,
  //   }),
  //   Question(id: '10', title: ' Ai là người phát triển BongRo', option: {
  //     'Rasmus Lerdorf': true,
