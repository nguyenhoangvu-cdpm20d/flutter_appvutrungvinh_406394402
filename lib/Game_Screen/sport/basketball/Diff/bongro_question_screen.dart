...
class BongRo_Diff_QuestionScreen extends StatefulWidget {
  const BongRo_Diff_QuestionScreen({super.key});

  @override
  State<BongRo_Diff_QuestionScreen> createState() =>
      BongRo_Diff_QuestionScreenState();
}

class BongRo_Diff_QuestionScreenState
    extends State<BongRo_Diff_QuestionScreen> {
  var db = DBConnect_BongRo_Diff();
  ...
  // ];
  Future? _questions;
  Future<List<BongRo>> getData() async {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<BongRo>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractedData = snapshot.data as List<BongRo>;
            return Scaffold(
